package com.example.medicalcare.VideoCallPackage.repository;
        ...
        import com.example.medicalcare.VideoCallPackage.remote.FirebaseClient;
        import com.example.medicalcare.VideoCallPackage.utils.DataModel;
        import com.example.medicalcare.VideoCallPackage.utils.DataModelType;
        import com.example.medicalcare.VideoCallPackage.utils.ErrorCallBack;
        import com.example.medicalcare.VideoCallPackage.utils.NewEventCallBack;
        import com.example.medicalcare.VideoCallPackage.utils.SuccessCallBack;
        import com.example.medicalcare.VideoCallPackage.webrtc.MyPeerConnectionObserver;
        import com.example.medicalcare.VideoCallPackage.webrtc.WebRTCClient;
...
public class MainRepository implements WebRTCClient.Listener {
    ...
    public void sendRejectCallRequest(String target, ErrorCallBack errorCallBack){
        firebaseClient.sendMessageToOtherUser(
                new DataModel(target,currentUsername,null, DataModelType.RejectCall),errorCallBack
        );
    }
    ...
    public void subscribeForLatestEvent(NewEventCallBack callBack){
        firebaseClient.observeIncomingLatestEvent(model -> {
            switch (model.getType()){
                ...
                case RejectCall:this.target = model.getSender();
                    callBack.onNewEventReceived(model);break;
            }
