...
import com.example.medicalcare.databinding.ActivityChangePasswordBinding;
...
public class ChangePasswordActivity extends AppCompatActivity {
    ...
    ActivityChangePasswordBinding views;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        views=ActivityChangePasswordBinding.inflate(getLayoutInflater());
        ...
        ref.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.hasChild(mobile)){
                    retrivedPassword=snapshot.child(mobile).child("password").getValue(String.class);
                }
            }
